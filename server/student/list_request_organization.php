  ...
  <div class="w3-col w3-border content w3-round">
    ...
    <div class="w3-padding" style="height: 180px;">
      ...
      <div class="w3-twothird w3-padding">
        ...
        <button class="w3-button w3-white w3-border w3-border-gray w3-round-large"><a href="student.php?status=request_organization&id=<?php echo $temp['id'];?>&organization_id=<?php echo $temp['organization_id'];?>">Xem chi tiết</a></button>
      </div>
    </div>
  </div>
<?php } ?>
