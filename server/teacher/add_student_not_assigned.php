...
<?php
  ...
  $sql = "INSERT INTO assigned_table(organization_request_id, student_id, start_date, end_date, status, create_date) VALUES('$request_id', '$student_id', '05-12-2019', '05-12-2020', '1', '05-12-2019')";
