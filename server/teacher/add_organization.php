<?php
  ...
  $sql = "INSERT INTO intern_organization_profile(organization_name, employee_count, gross_revenue, address, url, tax_number, avatar, password) VALUES('$name', '$employee', '$revenue', '$address', '$home', '$code', '$image', '$password')";
