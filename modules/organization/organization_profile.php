...
<div class="w3-container w3-margin">
  ...
  <button class="w3-button w3-white w3-border w3-border-red w3-round-large"><a href="organization.php?status=update_profile&organization_id=<?php echo $id;?>">Cập nhật thông tin</a></button>
  <button class="w3-button w3-white w3-border w3-border-red w3-round-large"><a href="organization.php?status=update_pass&organization_id=<?php echo $id;?>">Cập nhật mật khẩu</a></button>
  <button><a href="organization.php?status=list_requests" class="w3-button w3-white w3-border w3-border-grey w3-round-large">Quay lại</a></button>
</div>
